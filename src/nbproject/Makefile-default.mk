...
SOURCEFILES_QUOTED_IF_SPACED=main.c app_device_keyboard.c usb_descriptors.c system.c app_device_cdc_basic.c log.c bsp_keypad_v1/buttons.c bsp_keypad_v1/leds.c usb/src/usb_device.c usb/src/usb_device_hid.c usb_device_cdc.c bsp_keypad_v1/matrix.c bsp_keypad_v1/pixel.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/app_device_keyboard.p1 ${OBJECTDIR}/usb_descriptors.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/app_device_cdc_basic.p1 ${OBJECTDIR}/log.p1 ${OBJECTDIR}/bsp_keypad_v1/buttons.p1 ${OBJECTDIR}/bsp_keypad_v1/leds.p1 ${OBJECTDIR}/usb/src/usb_device.p1 ${OBJECTDIR}/usb/src/usb_device_hid.p1 ${OBJECTDIR}/usb_device_cdc.p1 ${OBJECTDIR}/bsp_keypad_v1/matrix.p1 ${OBJECTDIR}/bsp_keypad_v1/pixel.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/app_device_keyboard.p1.d ${OBJECTDIR}/usb_descriptors.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/app_device_cdc_basic.p1.d ${OBJECTDIR}/log.p1.d ${OBJECTDIR}/bsp_keypad_v1/buttons.p1.d ${OBJECTDIR}/bsp_keypad_v1/leds.p1.d ${OBJECTDIR}/usb/src/usb_device.p1.d ${OBJECTDIR}/usb/src/usb_device_hid.p1.d ${OBJECTDIR}/usb_device_cdc.p1.d ${OBJECTDIR}/bsp_keypad_v1/matrix.p1.d ${OBJECTDIR}/bsp_keypad_v1/pixel.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/app_device_keyboard.p1 ${OBJECTDIR}/usb_descriptors.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/app_device_cdc_basic.p1 ${OBJECTDIR}/log.p1 ${OBJECTDIR}/bsp_keypad_v1/buttons.p1 ${OBJECTDIR}/bsp_keypad_v1/leds.p1 ${OBJECTDIR}/usb/src/usb_device.p1 ${OBJECTDIR}/usb/src/usb_device_hid.p1 ${OBJECTDIR}/usb_device_cdc.p1 ${OBJECTDIR}/bsp_keypad_v1/matrix.p1 ${OBJECTDIR}/bsp_keypad_v1/pixel.p1

# Source Files
SOURCEFILES=main.c app_device_keyboard.c usb_descriptors.c system.c app_device_cdc_basic.c log.c bsp_keypad_v1/buttons.c bsp_keypad_v1/leds.c usb/src/usb_device.c usb/src/usb_device_hid.c usb_device_cdc.c bsp_keypad_v1/matrix.c bsp_keypad_v1/pixel.c
...
${OBJECTDIR}/bsp_keypad_v1/buttons.p1: bsp_keypad_v1/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/bsp_keypad_v1" 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/buttons.p1.d 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/buttons.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"bsp_keypad_v1" -I"./" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=200  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/bsp_keypad_v1/buttons.p1 bsp_keypad_v1/buttons.c 
	@-${MV} ${OBJECTDIR}/bsp_keypad_v1/buttons.d ${OBJECTDIR}/bsp_keypad_v1/buttons.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/bsp_keypad_v1/buttons.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/bsp_keypad_v1/leds.p1: bsp_keypad_v1/leds.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/bsp_keypad_v1" 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/leds.p1.d 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/leds.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"bsp_keypad_v1" -I"./" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=200  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/bsp_keypad_v1/leds.p1 bsp_keypad_v1/leds.c 
	@-${MV} ${OBJECTDIR}/bsp_keypad_v1/leds.d ${OBJECTDIR}/bsp_keypad_v1/leds.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/bsp_keypad_v1/leds.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/bsp_keypad_v1/matrix.p1: bsp_keypad_v1/matrix.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/bsp_keypad_v1" 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/matrix.p1.d 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/matrix.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"bsp_keypad_v1" -I"./" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=200  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/bsp_keypad_v1/matrix.p1 bsp_keypad_v1/matrix.c 
	@-${MV} ${OBJECTDIR}/bsp_keypad_v1/matrix.d ${OBJECTDIR}/bsp_keypad_v1/matrix.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/bsp_keypad_v1/matrix.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/bsp_keypad_v1/pixel.p1: bsp_keypad_v1/pixel.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/bsp_keypad_v1" 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/pixel.p1.d 
	@${RM} ${OBJECTDIR}/bsp_keypad_v1/pixel.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"bsp_keypad_v1" -I"./" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=200  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/bsp_keypad_v1/pixel.p1 bsp_keypad_v1/pixel.c 
	@-${MV} ${OBJECTDIR}/bsp_keypad_v1/pixel.d ${OBJECTDIR}/bsp_keypad_v1/pixel.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/bsp_keypad_v1/pixel.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
